...
라이센스
--------
Kiwi와 kiwipiepy는 Apache License 2.0 라이센스로 배포됩니다.

학습된 모델 파일(kiwipiepy_model) 또한 동일한 라이센스로 배포됩니다. 모델 학습에는 국립국어원의 21세기 세종계획 말뭉치와 모두의 말뭉치를 사용했으며, 원본 말뭉치 자체는 함께 배포되지 않습니다. 자세한 내용은 NOTICE 파일을 참고해주세요.
...
* 0.22.1 (2025-11-25)
    ...
    * kiwipiepy를 소스로부터 빌드 시 numpy를 찾을 수 없다는 오류가 발생하는 버그 수정
    * 이제 kiwipiepy가 Python Stable ABI를 지원합니다.
