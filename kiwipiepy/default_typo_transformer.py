...
_continual_defs = [
    ...
    TypoDefinition(["ᆨᄋ"], ["ᄀ"], 1., "continual"),
	TypoDefinition(["ᆩᄋ", "ᆨᄀ"], ["ᄁ", "ᆨᄀ"], 1., "continual"),
	TypoDefinition(["ᆪᄋ", "ᆪᄒ"], ["ᆨᄉ", "ᆨᄊ"], 1., "continual"),
	TypoDefinition(["ᆫᄋ", "ᆫᄒ"], ["ᄂ"], 1., "continual"),
	TypoDefinition(["ᆬᄋ", "ᆫᄌ"], ["ᆬᄋ", "ᆫᄌ"], 1., "continual"),
	TypoDefinition(["ᆭᄋ"], ["ᆫᄒ", "ᄂ"], 1., "continual"),
	TypoDefinition(["ᆭᄀ"], ["ᆫᄏ"], 1., "continual"),
	TypoDefinition(["ᆭᄃ"], ["ᆫᄐ"], 1., "continual"),
	TypoDefinition(["ᆭᄇ"], ["ᆫᄑ"], 1., "continual"),
	TypoDefinition(["ᆭᄉ"], ["ᆫᄉ"], 1., "continual"),
	TypoDefinition(["ᆭᄌ"], ["ᆫᄎ"], 1., "continual"),
	TypoDefinition(["ᆮᄋ"], ["ᄃ"], 1., "continual"),
	TypoDefinition(["ᆯᄋ", "ᆯᄒ"], ["ᄅ"], 1., "continual"),
	TypoDefinition(["ᆰᄋ"], ["ᆯᄀ"], 1., "continual"),
	TypoDefinition(["ᆰᄀ"], ["ᆯᄁ"], 1., "continual"),
	TypoDefinition(["ᆰᄒ"], ["ᆯᄏ"], 1., "continual"),
	TypoDefinition(["ᆱᄋ", "ᆱᄒ"], ["ᆯᄆ"], 1., "continual"),
	TypoDefinition(["ᆲᄋ"], ["ᆯᄇ"], 1., "continual"),
	TypoDefinition(["ᆲᄇ"], ["ᆯᄈ"], 1., "continual"),
	TypoDefinition(["ᆲᄒ"], ["ᆯᄑ"], 1., "continual"),
	TypoDefinition(["ᆳᄋ"], ["ᆯᄉ"], 1., "continual"),
	TypoDefinition(["ᆳᄉ"], ["ᆯᄊ"], 1., "continual"),
	TypoDefinition(["ᆴᄋ", "ᆴᄐ", "ᆴᄒ"], ["ᆯᄐ"], 1., "continual"),
	TypoDefinition(["ᆵᄋ", "ᆵᄑ", "ᆵᄒ"], ["ᆯᄑ"], 1., "continual"),
	TypoDefinition(["ᆶᄉ"], ["ᆯᄉ"], 1., "continual"),
	TypoDefinition(["ᆶᄋ", "ᆶᄒ"], ["ᆯᄒ"], 1., "continual"),
	TypoDefinition(["ᆷᄋ", "ᆷᄒ"], ["ᄆ"], 1., "continual"),
	TypoDefinition(["ᆸᄋ"], ["ᄇ"], 1., "continual"),
	TypoDefinition(["ᆸᄇ"], ["ᄈ"], 1., "continual"),
	TypoDefinition(["ᆹᄋ", "ᆹᄒ"], ["ᆸᄉ", "ᆸᄊ"], 1., "continual"),
	TypoDefinition(["ᆺᄋ"], ["ᄉ"], 1., "continual"),
	TypoDefinition(["ᆻᄋ", "ᆺᄉ"], ["ᄊ", "ᆺᄉ"], 1., "continual"),
	TypoDefinition(["ᆽᄋ"], ["ᄌ"], 1., "continual"),
	TypoDefinition(["ᆽᄌ"], ["ᄍ"], 1., "continual"),
	TypoDefinition(["ᆾᄋ", "ᆾᄒ", "ᆽᄒ", "ᇂᄌ", "ᇂᄎ"], ["ᄎ"], 1., "continual"),
	TypoDefinition(["ᆿᄋ", "ᆿᄒ", "ᆨᄒ", "ᇂᄀ", "ᇂᄏ"], ["ᄏ"], 1., "continual"),
	TypoDefinition(["ᇀᄋ", "ᇀᄒ", "ᆮᄒ", "ᇂᄃ", "ᇂᄐ"], ["ᄐ"], 1., "continual"),
	TypoDefinition(["ᇁᄋ", "ᇁᄒ", "ᆸᄒ", "ᇂᄇ", "ᇂᄑ"], ["ᄑ"], 1., "continual"),
	TypoDefinition(["ᇂᄋ"], ["ᄒ"], 1., "continual"),
]
